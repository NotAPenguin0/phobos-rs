...
use phobos::{
    Allocator, AppBuilder, DefaultAllocator, Device, ExecutionManager,
    GPURequirements, Instance, PhysicalDevice, QueueRequest, QueueType,
};
...
pub fn make_context_with_queues(queues: impl Into<Vec<QueueRequest>>) -> Result<Context<DefaultAllocator>> {
